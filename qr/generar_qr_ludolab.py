"""
generar_qr_ludolab.py
=====================
Variante de la plantilla v2 BIG de las cartas QR:
- SIN corona decorativa en la parte superior.
- Banda superior: "LudoLab.cl" en lugar de "EDICIÓN ESPECIAL".
- Resto igual a generar_qr_v2_big.py.

Uso:
    cd qr/
    python3 generar_qr_ludolab.py                  # genera el default ["01"]
    python3 generar_qr_ludolab.py 01 02 03 ...     # genera esos IDs
"""
...
def generar_qr(num):
    ...
    # Footer "ANVERSO · ID XX · 1536 – 1910"
    FT_LINE = H - 60
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        IDS = sys.argv[1:]
    print(f"Generando {len(IDS)} QR BIG (LudoLab)...\n")
    for num in IDS:
        generar_qr(num)
    print("\nListo.")
